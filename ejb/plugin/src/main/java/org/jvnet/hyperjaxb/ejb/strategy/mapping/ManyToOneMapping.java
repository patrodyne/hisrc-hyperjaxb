...
public class ManyToOneMapping implements FieldOutlineMapping<ManyToOne>
{
	...
	{
		final ManyToOne manyToOne = context.getCustomizing().getManyToOne(fieldOutline);
	...
	public void createManyToOne$Name(Mapping context, FieldOutline fieldOutline, final ManyToOne manyToOne)
	{
		manyToOne.setName(context.getNaming().getPropertyName(context, fieldOutline));
	}

	public void createManyToOne$TargetEntity(Mapping context, FieldOutline fieldOutline, final ManyToOne manyToOne)
	{
		...
		manyToOne.setTargetEntity(
			context.getNaming().getEntityClass(context, fieldOutline.parent().parent(), childClassInfo.getType()));
	}

	public void createManyToOne$JoinTableOrJoinColumn(Mapping context, FieldOutline fieldOutline, ManyToOne manyToOne)
	{
