...
IMGTYPE="svg"
DIAGRAM_NAME="Publication"
PLANTUML_HOME="/opt/java/plantuml"
PLANTUML_TEMP="target/generated-docs/${DIAGRAM_NAME}ClassesTemp.puml"
PLANTUML_FILE="target/generated-docs/${DIAGRAM_NAME}Classes.puml"
PLANTUML_DEST="src/main/resources/${DIAGRAM_NAME}Classes.${IMGTYPE}"
# Configure END
