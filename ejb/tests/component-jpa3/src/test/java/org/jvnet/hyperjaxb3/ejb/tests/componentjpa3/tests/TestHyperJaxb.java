...
public class TestHyperJaxb {
    ...
    public void testMapping() throws Exception {
        ...
        JobStream jaxbElement = (JobStream) JAXBContextUtils.unmarshal("org.jvnet.hyperjaxb3.ejb.tests.componentjpa3.tests", readFileAsString("src/test/resources/tests.xml"));
    ...
    private String getPersistenceUnitName() {
        return "org.jvnet.hyperjaxb3.ejb.tests.componentjpa3.tests";
    }
