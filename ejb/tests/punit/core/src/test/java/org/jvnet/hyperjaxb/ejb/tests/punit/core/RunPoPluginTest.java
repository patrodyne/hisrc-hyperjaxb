package org.jvnet.hyperjaxb.ejb.tests.punit.core;
...
@Order(1)
public class RunPoPluginTest extends AbstractHyperMojoTest
{
	@Test
	public void testExecute() throws Exception
	{
		...
		mojo.setPersistenceXml(fullpath("src/main/etc/persistence.xml"));
