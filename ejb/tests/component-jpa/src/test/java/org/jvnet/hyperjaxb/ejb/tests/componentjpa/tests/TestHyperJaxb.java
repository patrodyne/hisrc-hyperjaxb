...
import org.jvnet.hyperjaxb.ejb.tests.componentjpa.tests.JobStream;
import org.jvnet.hyperjaxb.ejb.util.EntityManagerFactoryUtil;
...
public class TestHyperJaxb {
    ...
    public void testMapping() throws Exception {
        ...
        JobStream jaxbElement = (JobStream) JAXBContextUtils.unmarshal("org.jvnet.hyperjaxb.ejb.tests.componentjpa.tests", readFileAsString("src/test/resources/tests.xml"));
