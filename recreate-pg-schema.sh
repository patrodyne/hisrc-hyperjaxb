...
${SQLCMD} "ejb/tests/po-jpa-2.1/${SQLFILE}" | grep "GRANT ALL"
...
${SQLCMD} "ejb/tests/issues-jpa2/${SQLFILE}" | grep "GRANT ALL"
...
${SQLCMD} "ejb/tests/embeddable-jpa2/${SQLFILE}" | grep "GRANT ALL"
